...
{
    public partial class AdmContactMessages : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            op.InsEvent.EventDescr = "User edited a Contact Message with the id: " + idItem + "!";
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            op.InsEvent = new EventDb();
            op.InsEvent.IdUser = idUser;
            op.InsEvent.EventDescr = "User deleted a Contact Message with the id: " + idItem + "!";
            op.InsEvent.Time = DateTime.Now;
